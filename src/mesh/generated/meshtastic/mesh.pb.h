...
typedef enum _meshtastic_MeshPacket_TransportMechanism {
    ...
    /* Arrived via a bridge (UART/RS485) connection */
    meshtastic_MeshPacket_TransportMechanism_TRANSPORT_BRIDGE = 8
...
#define _meshtastic_MeshPacket_TransportMechanism_MAX meshtastic_MeshPacket_TransportMechanism_TRANSPORT_BRIDGE
#define _meshtastic_MeshPacket_TransportMechanism_ARRAYSIZE ((meshtastic_MeshPacket_TransportMechanism)(meshtastic_MeshPacket_TransportMechanism_TRANSPORT_BRIDGE+1))
