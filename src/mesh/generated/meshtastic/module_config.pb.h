...
/* Link type for the bridge connection */
typedef enum _meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType {
    /* Generic UART link (DE pin optional) */
    meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType_LINK_UART = 0,
    /* RS485 serial link (requires DE pin) */
    meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType_LINK_RS485 = 1
} meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType;
...
/* Config for the Bridge Module */
typedef struct _meshtastic_ModuleConfig_BridgeConfig {
    /* Whether the Bridge Module is enabled */
    bool enabled;
    /* RX GPIO pin */
    uint32_t rxd;
    /* TX GPIO pin */
    uint32_t txd;
    /* Direction enable (DE) GPIO pin for RS485 half-duplex control.
 Required for LINK_RS485, optional for LINK_UART. */
    uint32_t de_pin;
    /* Serial baud rate (reuses SerialConfig baud enum) */
    meshtastic_ModuleConfig_SerialConfig_Serial_Baud baud;
    /* Link type for the bridge connection */
    meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType link_type;
    /* List of portnums to block from being forwarded over the bridge.
 Add portnum values (e.g. 67 for TELEMETRY_APP) to prevent those
 packet types from crossing the bridge link.
 ROUTING_APP is always blocked regardless of this list. */
    pb_size_t blocked_portnums_count;
    uint32_t blocked_portnums[8];
} meshtastic_ModuleConfig_BridgeConfig;
...
typedef struct _meshtastic_ModuleConfig {
    ...
    union {
        ...
        /* RS485 Bridge Config */
        meshtastic_ModuleConfig_BridgeConfig bridge;
    } payload_variant;
...
#define _meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType_MIN meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType_LINK_UART
#define _meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType_MAX meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType_LINK_RS485
#define _meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType_ARRAYSIZE ((meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType)(meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType_LINK_RS485+1))
...
#define meshtastic_ModuleConfig_BridgeConfig_baud_ENUMTYPE meshtastic_ModuleConfig_SerialConfig_Serial_Baud
#define meshtastic_ModuleConfig_BridgeConfig_link_type_ENUMTYPE meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType
...
#define meshtastic_ModuleConfig_BridgeConfig_init_default {0, 0, 0, 0, _meshtastic_ModuleConfig_SerialConfig_Serial_Baud_MIN, _meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType_MIN, 0, {0, 0, 0, 0, 0, 0, 0, 0}}
...
#define meshtastic_ModuleConfig_BridgeConfig_init_zero {0, 0, 0, 0, _meshtastic_ModuleConfig_SerialConfig_Serial_Baud_MIN, _meshtastic_ModuleConfig_BridgeConfig_BridgeLinkType_MIN, 0, {0, 0, 0, 0, 0, 0, 0, 0}}
...
#define meshtastic_ModuleConfig_BridgeConfig_enabled_tag 1
#define meshtastic_ModuleConfig_BridgeConfig_rxd_tag 2
#define meshtastic_ModuleConfig_BridgeConfig_txd_tag 3
#define meshtastic_ModuleConfig_BridgeConfig_de_pin_tag 4
#define meshtastic_ModuleConfig_BridgeConfig_baud_tag 5
#define meshtastic_ModuleConfig_BridgeConfig_link_type_tag 6
#define meshtastic_ModuleConfig_BridgeConfig_blocked_portnums_tag 7
...
#define meshtastic_ModuleConfig_bridge_tag       15
...
X(a, STATIC,   ONEOF,    MESSAGE,  (payload_variant,bridge,payload_variant.bridge),  15)
...
#define meshtastic_ModuleConfig_payload_variant_bridge_MSGTYPE meshtastic_ModuleConfig_BridgeConfig
...
#define meshtastic_ModuleConfig_BridgeConfig_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, BOOL,     enabled,           1) \
X(a, STATIC,   SINGULAR, UINT32,   rxd,               2) \
X(a, STATIC,   SINGULAR, UINT32,   txd,               3) \
X(a, STATIC,   SINGULAR, UINT32,   de_pin,            4) \
X(a, STATIC,   SINGULAR, UENUM,    baud,              5) \
X(a, STATIC,   SINGULAR, UENUM,    link_type,         6) \
X(a, STATIC,   REPEATED, UINT32,   blocked_portnums,   7)
#define meshtastic_ModuleConfig_BridgeConfig_CALLBACK NULL
#define meshtastic_ModuleConfig_BridgeConfig_DEFAULT NULL
...
extern const pb_msgdesc_t meshtastic_ModuleConfig_BridgeConfig_msg;
...
#define meshtastic_ModuleConfig_BridgeConfig_fields &meshtastic_ModuleConfig_BridgeConfig_msg
...
#define meshtastic_ModuleConfig_BridgeConfig_size 72
